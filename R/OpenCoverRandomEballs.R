#' @title OpenCoverRandomEballs
#'
#' @param adjacency_matrix an n X n matrix of 1's and 0's
#'
#' @return a list of open covers
#'
#' @examples some_vector %>% dist() %>% AdjacencyMatrix(some_epsilon) %>% OpenCoverRandomEballs()
OpenCoverRandomEballs <- function(adjacency_matrix, messages = FALSE) {
  ###########################
